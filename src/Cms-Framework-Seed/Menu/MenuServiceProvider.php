...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('menu', function ($app) {
            return $this->app->make('Cms_Framework_Seed\Menu\Menu');
        });

        // Bind Menu to repository
        $this->app->bind(
            'Cms_Framework_Seed\Menu\Interfaces\MenuRepositoryInterface',
            \Cms_Framework_Seed\Menu\Repositories\Eloquent\MenuRepository::class
        );

        $this->app->register(\Cms_Framework_Seed\Menu\Providers\AuthServiceProvider::class);
        $this->app->register(\Cms_Framework_Seed\Menu\Providers\RouteServiceProvider::class);
    }
