...
namespace Cms_Framework_Seed\Settings\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Cms_Framework_Seed\Settings\Http\Requests\SettingRequest;
    ...
    public function index(SettingRequest $request)
    {
        if ($this->response->typeIs('json')) {
            ...
            $data = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Settings\Repositories\Presenter\SettingPresenter::class)
