...
namespace Cms_Framework_Seed\Http;

use Form;
use Cms_Framework_Seed\Http\Traits\Request;
use Cms_Framework_Seed\Http\Traits\Theme;
use Cms_Framework_Seed\Http\Traits\View;
