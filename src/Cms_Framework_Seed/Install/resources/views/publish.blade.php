                        ...
                        <div class="wizard-container">
                            <div class="wizard-card" id="wizard">
                                <div class="wizard-header">
                                    ...
                                    <p class="category">Cms_Framework_Seed Installation Wizard</p>
                                </div>
                                ...
                                <div class="tab-content">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h5 class="info-text">Publish config, assets, public files, language files, default theme, migratins and seeds for cms_framework_seed and cms_framework_seed packages.</h5>
                                        </div>
