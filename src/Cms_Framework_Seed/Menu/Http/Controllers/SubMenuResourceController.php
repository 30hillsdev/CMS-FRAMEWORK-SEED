...
namespace Cms_Framework_Seed\Menu\Http\Controllers;

use App\Http\Controllers\ResourceController as ResourceController;
use Form;
use Cms_Framework_Seed\Menu\Http\Requests\MenuRequest;
use Cms_Framework_Seed\Menu\Interfaces\MenuRepositoryInterface;
use Cms_Framework_Seed\Menu\Models\Menu as Menu;
